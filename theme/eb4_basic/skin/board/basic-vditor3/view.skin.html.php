...
if ($config['cf_editor'] == 'vditor3') {
    global $config;

    $vditor3_url = G5_EDITOR_URL.'/'.$config['cf_editor'];

    add_stylesheet('<link rel="stylesheet" href="'.$vditor3_url.'/dist/index.css">', 0);
    add_javascript('<script src="'.$vditor3_url.'/dist/index.min.js"></script>', 0);
    add_javascript('<script src="'.$vditor3_url.'/editorOptions.js"></script>', 0);
}
?>
...
<article class="board-view">
    ...
    <div class="board-view-atc" id="view_good_nogood">
        ...
        <?php } ?>
        <?php if ($config['cf_editor'] == 'tuieditor') { ?>
            <div id="board_view_con" class="board-view-con view-content"><?php echo $view_content; ?></div>
            <?php echo $bbs->tuieditor_viewer("board_view_con"); ?>
        <?php } else if ($config['cf_editor'] == 'vditor3') { ?>
            <div id="board_view_con" class="board-view-con view-content"></div>
            <textarea id="markdownText" class="preview" style="display:none;"><?php echo $view_content;?></textarea>
        <?php } else { ?>
            <div id="board_view_con" class="board-view-con view-content"><?php echo $view_content; ?></div>
        <?php } ?>
...
<script>
Vditor.preview(document.getElementById('board_view_con'),
